...
// 该数组会自动生成菜单，面包屑和路由
// type: home  Menu  MenuItem  subItem

//export default [
//    // 首页
//    {key: 'home', name: '首页', path: '/', type: 'home'},
//    // 资源概览
//    {key: 'overview', name: '资源概览', path: '/overview', type: 'menuItem', component: Overview, icon: 'user'},
//    // 块存储
//    {key: 'blockstorage', name: '块存储', path: '/blockstorage', type: 'menu', icon: 'user'},
...
//    // 监控管理
//    {key: 'monitormanage', name: '监控管理', path: '/monitormanage', type: 'menu', icon: 'user'},
...
//    // 资源管理
//    {key: 'resourcemanage', name: '资源管理', path: '/resourcemanage', type: 'menu', icon: 'user'},
...
//    // 数据保护
//    {key: 'dataprotect', name: '数据保护', path: '/dataprotect', type: 'menu', icon: 'user'},
//    {key: 'datamigration', name: '数据迁移', path: '/dataprotect/datamigration', type: 'subItem', component: Page404},
//    // 系统管理
//    {key: 'systemmanage', name: '系统管理', path: '/systemmanage', type: 'menu', icon: 'user'},
